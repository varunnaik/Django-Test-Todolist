"""
    Even though this file should be part of the TastyPie distribution, it does
    not seem to be included in the download (unless you got Tastypie from git).
    Therefore, I have downloaded it and included it here for testing separately.
    
    Another possible solution is to download the latest Tastypie from Git and add
    the entire tastypie directory to your project manually, instead of using 
